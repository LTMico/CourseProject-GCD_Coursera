...
The code and dataset included in this github repo are intended to satisfy the requirements of the Coursera 'Getting and Cleaning' course running through September of 2015.  The information below is compiled from 1) the coursera website 2) the source dataset codebook (features info.txt) and associated ReadMe documentation (README.txt).  A brief description of the analytical process applied in run_analysis.R is included at the end of this document
...
Instructions/requirements for the project are as follows (reproduced from the Coursera website)
...
##EXPERIMENT OVERVIEW AND METRIC DESCRIPTION

The info below is reprodcued from the features info.txt document included with the original dataset
...
##DESCRIPTION OF FILES INCLUDED IN THE DATASET

The info below is reprodcued from the README.txt document included with the original dataset
